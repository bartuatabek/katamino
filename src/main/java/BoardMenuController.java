...
public class BoardMenuController implements Initializable {
    ...
    */
    ...
    public void boardButtonClicked(MouseEvent event) throws IOException {
        /*FXMLLoader levelMenuLoader = new FXMLLoader(getClass().getResource("multiplayerGame.fxml"));
        Stage stage = (Stage) ((Node)event.getSource()).getScene().getWindow();
        AnchorPane pane = levelMenuLoader.load();
        MultiplayerGameController gameController = levelMenuLoader.getController();
        stage.setWidth(1250);
        stage.setHeight(700);
